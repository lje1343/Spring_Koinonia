...
//
//        if(boardReplyVO.getReplyWriter() == null){ // JSON 검증
//            boardReplyVO.setReplyWriter(Optional.ofNullable(replyWriter).orElse("anonymous")); // URI 검증
//        }
//        boardReplyVO.setReplyNumber(replyNumber);
